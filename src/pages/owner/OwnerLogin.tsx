...
import { Mail, Lock, Building, Eye, EyeOff, ArrowRight, TrendingUp } from "lucide-react";
        ...
        <div className={`max-w-md mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <Card className="shadow-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-8">
              ...
              <p className="text-muted-foreground mt-2">Access your property dashboard</p>
            </CardHeader>
            ...
            <CardContent className="px-8 pb-8">
              ...
              <div className="mt-8 text-center">
                <p className="text-muted-foreground">
                  ...
                  <Link to="/owner/signup" className="text-primary hover:text-primary-dark font-semibold transition-colors">
                    Create one now
                  </Link>
                </p>
              </div>
