...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setIsMobileOpen(false);
      ...
      const headerBase = "bg-background dark:bg-background-dark border-b border-border sticky top-0 z-50 backdrop-blur-sm bg-background/95 dark:bg-background-dark/95 transition-all duration-300";

  return (
    <header className={`${headerBase} ${hasShadow ? "shadow-lg" : "shadow-none"}`}>
